...
struct RecentsGrid: View {
    ...
    // Returns an ordered collection of unique elements.
    // In this case, returns an array of models for which the first element is the most recently placed model and the last element the least recently placed model.
